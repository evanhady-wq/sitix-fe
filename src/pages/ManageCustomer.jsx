  ...
  const [error, setError] = useState(null);
    ...
    const filteredItems = useMemo(() => {
      ...
      if (statusFilter !== "all" && Array.from(statusFilter).length !== statusOptions.length) {
        filtered = filtered.filter((customer) =>
          Array.from(statusFilter).includes(customer.isDeleted.toString()),
        );
      }
      return filtered;
    ...
    const fetchData = async () => {
      ...
      return (
        ...
        <div className="flex h-screen ">
          ...
          <p className="font-bold">Daftar Customer</p>
    ...
    >
      <TableHeader>
      <TableColumn style={{backgroundColor: "#1F316F", color:"white"}} key="id" className="text-lg">ID Customer</TableColumn>
          ...
          >
            <div className="relative w-auto my-6 mx-auto max-w-3xl">
              ...
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                ...
                <p>Anda yakin akan menghapus customer atas nama {selectedCustomer.name}?</p>
                </div>
                {/*footer*/}
                <div className="flex items-center justify-end p-4 border-t border-solid border-blueGray-200 rounded-b">
                  ...
                  <button
                    ...
                    type="button"
                    onClick={() => handleModalDelete(selectedCustomer.id)}
                  >
                    Delete
                  </button>
                </div>
...
export default withLoading(ManageCustomer);